...
//		out.print("<p>writerID : " + writerID + "</p>");
//		out.print("<p>title : " + title + "</p>");
//		out.print("<p>content : " + content + "</p>");
//		
//		out.print("<hr/>");
//		
//		if(imgLocation_1 == null) {
//			out.print("<h1>imgLocation_1 이 NULL 입니다</h1>");
//		}
//		
//		out.print("<p>imgLocation_1 : " + imgLocation_1 + "</p>");
//		out.print("<p>imgOriginLocation_1 : " + imgOriginLocation_1 + "</p>");
//		out.print("<br/>");
//		out.print("<p>imgLocation_2 : " + imgLocation_2 + "</p>");
//		out.print("<p>imgOriginLocation_2 : " + imgOriginLocation_2 + "</p>");
//		out.print("<br/>");
//		out.print("<p>imgLocation_3 : " + imgLocation_3 + "</p>");
//		out.print("<p>imgOriginLocation_3 : " + imgOriginLocation_3 + "</p>");
//		
//		out.close();
	}
}
